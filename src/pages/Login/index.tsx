  ...
  return (
    <div className=" flex justify-center h-screen bg-neutral-200 content-center py-96 ">
      <div className="bg-slate-50 w-96 h-96 flex flex-col justify-center content-center rounded-lg shadow-lg ">
        <div className="target:next-center text-2xl font-bold text-purple-800 p-4 align self-center">Login</div>
        ...
        <div>
          <button onClick={handleLogin} className="target:next-center w-48 border border-purple-800 m-4 p-2 align self-center">entrar</button>
        </div>
      </div>
    </div>
  )
